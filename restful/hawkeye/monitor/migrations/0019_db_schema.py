...
# Embedded file name: ./monitor/migrations/0019_db_schema.py
...
class Migration(migrations.Migration):
    dependencies = [
     ('monitor', '0018_oracle_ash_session_type')]
    operations = [
     migrations.CreateModel(name='DB_SCHEMA',
       fields=[
      (
...
# okay decompiling ./restful/hawkeye/monitor/migrations/0019_db_schema.pyc
