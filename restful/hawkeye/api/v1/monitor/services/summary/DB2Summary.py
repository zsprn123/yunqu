...
# Embedded file name: ./api/v1/monitor/services/summary/DB2Summary.py
...
def get_db2_summary(pk):
    ...
    return summary_data
# okay decompiling ./restful/hawkeye/api/v1/monitor/services/summary/DB2Summary.pyc
